...
| Param | Type | Description | | --- | --- | --- | | hash | string | hash to be fetched | | mode | string | mode could
be either public or restricted | | secret | string | secret of the data in case of restricted mode only |
